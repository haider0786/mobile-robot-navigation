...
sub2 = rospy.Subscriber("robot2/cmd_vel", Twist, newOdom2)
sub3 = rospy.Subscriber("robot1/odom", Odometry, odomrobot2)
    ...
    try:
        if counter_o > 2:
            ...
            if counter_in == time_step:
                ...
                angular_velocity = z_model.predict([Input_w_3d, Input_obs_info, Input_pos_3d])
                linear_velocity = x_model.predict([Input_w_3d, Input_obs_info, Input_pos_3d])
