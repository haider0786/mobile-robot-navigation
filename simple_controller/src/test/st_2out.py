...
z_model = load_model('/home/robita/PycharmProjects/classification/out_2_1.h5')
x_model = load_model('/home/robita/PycharmProjects/classification/runtime_L13.h5')
angl_dist = []
angl_dist1 = []
laser = []
Input_pos = []
...
while not rospy.is_shutdown():
    try:
        ...
        if counter_o > 2:
            ...
            # print Input_w_3d
            # print Input_pos_3d
            velocity = z_model.predict([Input_w_3d, Input_pos_3d])
