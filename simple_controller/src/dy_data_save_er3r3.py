...
def emergencystop(flag_el,  theta_g, dg, speed_z, speed_x, value2, value3, value4):
    ...
    if flag_el >= 0 and flag_el <= 10:
        ...
        specific_pos_w1_temp.append(specific_pos_w_temp)
        specific_pos_v1_temp.append(specific_pos_v_temp)
        specific_las1_temp.append(value2)
        specific_las1_temp.append(value3)
        specific_las1_temp.append(value4)
        speed_z = 0.0
        speed_x = 0.0
        print("Emergency_stop")
        return( speed_z, speed_x, specific_pos_w1_temp, specific_pos_v1_temp, specific_las1_temp)
    if flag_el >= 10:
...
sub = rospy.Subscriber("robot3/base_scan", LaserScan, newOdom)
sub1 = rospy.Subscriber("robot3/odom", Odometry, newOdom1)
            ...
            if counter_in == time_step:
                ...
                if dg > 16 and abs(e1) > 0.1:
                    ...
                    if abs(e1) > 0.1:
                        ...
                        print("c1")
                    if min_val <= 0.5:
                        [speed.angular.z, speed.linear.x, specific_pos_w1, specific_pos_v1, specific_las1] = \
...
specific_pos_v1.to_csv('/home/robita/data_collected/run_time/dy_sr2/linear/v7.csv')
specific_pos_w1.to_csv('/home/robita/data_collected/run_time/dy_sr2/angular/w7.csv')
specific_las1.to_csv('/home/robita/data_collected/run_time/dy_sr2/laser/las7.csv')