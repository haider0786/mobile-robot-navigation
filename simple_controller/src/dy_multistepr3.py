...
z_model = load_model('/home/robita/PycharmProjects/classification/runtime_A14.h5')
x_model = load_model('/home/robita/PycharmProjects/classification/runtime_L14.h5')
angl_dist = []
angl_dist1 = []
laser = []
Input_pos = []
...
#angl_dist1.to_csv('/home/haider/result_sr2/multi_step/Dynamic/mdcr210_new.csv')
