...
z_model = load_model('/home/robita/PycharmProjects/classification/st_A1.h5')
x_model = load_model('/home/robita/PycharmProjects/classification/st_L1.h5')
angl_dist = []
angl_dist1 = []
laser = []
Input_pos = []
...
#angl_dist1.to_csv('/home/haider/result_sr2/single_step/Static/sstcr13_new.csv')
